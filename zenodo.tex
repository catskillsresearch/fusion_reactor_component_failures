...
\title{\textbf{Fusion Reactor Component Failures: A Review of Historical Non-Thermonuclear Energetic Excursions}}
...
\begin{center}
  ...
  \textbf{Version:} 1.0.0 \\[0.5em]
  \textbf{Source repository:} \url{https://github.com/catskillsresearch/fusion_reactor_component_failures}
\end{center}
...
\hypertarget{tokamak-de-fontenay-aux-roses-tfr-1973-localized-vacuum-boundary-degradation-via-relativistic-electron-beams}{%
\section{Tokamak de Fontenay-aux-Roses (TFR, 1973): Localized Vacuum-Boundary Degradation via Relativistic Electron Beams}\label{tokamak-de-fontenay-aux-roses-tfr-1973-localized-vacuum-boundary-degradation-via-relativistic-electron-beams}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Low{-}Density Regime \& High Impurities] {-}{-}\textgreater{} B[Inductive Electric Field Increase]}
\NormalTok{    B {-}{-}\textgreater{} C[Dreicer Runaway Acceleration]}
\NormalTok{    C {-}{-}\textgreater{} D[Relativistic Runaway Electron Beam]}
\NormalTok{    D {-}{-}\textgreater{} E[Trapped{-}Particle Ripple Drift]}
\NormalTok{    E {-}{-}\textgreater{} F[Localized Thermal Deposition on Inner Wall]}
\NormalTok{    F {-}{-}\textgreater{} G[0.5 mm Inconel Bellows Penetration]}
\NormalTok{    G {-}{-}\textgreater{} H[Atmospheric Air Ingress \& Plasma Termination]}
\end{Highlighting}
\end{Shaded}

\hypertarget{technical-and-design-baseline}{%
\subsection{2.1 Technical and Design Baseline}\label{technical-and-design-baseline}}
...
\hypertarget{chronology-of-the-incident}{%
\subsection{2.2 Chronology of the Incident}\label{chronology-of-the-incident}}
...
\hypertarget{physical-damage-and-operational-impact}{%
\subsection{2.3 Physical Damage and Operational Impact}\label{physical-damage-and-operational-impact}}
...
\hypertarget{root-cause-and-remediation}{%
\subsection{2.4 Root Cause and Remediation}\label{root-cause-and-remediation}}
...
\hypertarget{tokamak-fusion-test-reactor-tftr-1980-kinetic-energy-release-in-pulsed-power-flywheel-generators}{%
\section{Tokamak Fusion Test Reactor (TFTR, 1980): Kinetic Energy Release in Pulsed Power Flywheel Generators}\label{tokamak-fusion-test-reactor-tftr-1980-kinetic-energy-release-in-pulsed-power-flywheel-generators}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Pre{-}Operational Balancing Phase] {-}{-}\textgreater{} B[Rotor Dynamic Instability]}
\NormalTok{    B {-}{-}\textgreater{} C[Shaft Alignment Shear / Bearing Run{-}Out]}
\NormalTok{    C {-}{-}\textgreater{} D[Catastrophic Mechanical Failure of Bearings]}
\NormalTok{    D {-}{-}\textgreater{} E[Kinetic Energy Release in Power Supply Building]}
\NormalTok{    E {-}{-}\textgreater{} F[DOE Accident Investigation]}
\NormalTok{    F {-}{-}\textgreater{} G[Multi{-}Month Structural Reconstruction \& Sensor Upgrades]}
\end{Highlighting}
\end{Shaded}

\hypertarget{technical-and-design-baseline-1}{%
\subsection{3.1 Technical and Design Baseline}\label{technical-and-design-baseline-1}}
...
\hypertarget{chronology-of-the-incident-1}{%
\subsection{3.2 Chronology of the Incident}\label{chronology-of-the-incident-1}}
...
\hypertarget{physical-damage-and-operational-impact-1}{%
\subsection{3.3 Physical Damage and Operational Impact}\label{physical-damage-and-operational-impact-1}}
...
\hypertarget{root-cause-and-remediation-1}{%
\subsection{3.4 Root Cause and Remediation}\label{root-cause-and-remediation-1}}
...
\hypertarget{joint-european-torus-jet-1980s1990s-disruption-induced-vertical-forces-and-halo-currents}{%
\section{Joint European Torus (JET, 1980s--1990s): Disruption-Induced Vertical Forces and Halo Currents}\label{joint-european-torus-jet-1980s1990s-disruption-induced-vertical-forces-and-halo-currents}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Elongated Plasma Disruption] {-}{-}\textgreater{} B[Loss of Active Vertical Feedback Control]}
\NormalTok{    B {-}{-}\textgreater{} C[Vertical Displacement Event VDE]}
\NormalTok{    C {-}{-}\textgreater{} D[Plasma Contact with First{-}Wall Panels]}
\NormalTok{    D {-}{-}\textgreater{} E[Poloidal / Asymmetric Halo Current Flow]}
\NormalTok{    E {-}{-}\textgreater{} F[Lorentz Force J x B Interaction with TF Field]}
\NormalTok{    F {-}{-}\textgreater{} G[Transient Vertical Force \textgreater{} 25.5 MN Load]}
\NormalTok{    G {-}{-}\textgreater{} H[Vessel Displaced / Structural Bounce on Springs]}
\end{Highlighting}
\end{Shaded}

\hypertarget{technical-and-design-baseline-2}{%
\subsection{4.1 Technical and Design Baseline}\label{technical-and-design-baseline-2}}
...
\hypertarget{chronology-of-the-incident-2}{%
\subsection{4.2 Chronology of the Incident}\label{chronology-of-the-incident-2}}
...
\hypertarget{physical-damage-and-operational-impact-2}{%
\subsection{4.3 Physical Damage and Operational Impact}\label{physical-damage-and-operational-impact-2}}
...
\hypertarget{root-cause-and-remediation-2}{%
\subsection{4.4 Root Cause and Remediation}\label{root-cause-and-remediation-2}}
...
\hypertarget{jt-60u-2004-fatigue-induced-rotor-failure-in-heating-power-systems}{%
\section{JT-60U (2004): Fatigue-Induced Rotor Failure in Heating Power Systems}\label{jt-60u-2004-fatigue-induced-rotor-failure-in-heating-power-systems}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[High{-}Beta / High{-}Power Campaign] {-}{-}\textgreater{} B[Cyclic Fatigue on H{-}MG Rotor Shaft]}
\NormalTok{    C {-}{-}\textgreater{} D[Heating Motor{-}Generator H{-}MG Mechanical Failure]}
\NormalTok{    D {-}{-}\textgreater{} E[Auxiliary NBI / RF Systems Loss of Pulsed Power]}
\NormalTok{    E {-}{-}\textgreater{} F[Direct Grid Bypass Strategy Implemented]}
\NormalTok{    F {-}{-}\textgreater{} G[Commercial Substation Peak Power Limits Reach Saturation]}
\NormalTok{    G {-}{-}\textgreater{} H[TF Field Restricted to \textless{} 3 T Operation]}
\end{Highlighting}
\end{Shaded}

\hypertarget{technical-and-design-baseline-3}{%
\subsection{5.1 Technical and Design Baseline}\label{technical-and-design-baseline-3}}
...
\hypertarget{chronology-of-the-incident-3}{%
\subsection{5.2 Chronology of the Incident}\label{chronology-of-the-incident-3}}
...
\hypertarget{physical-damage-and-operational-impact-3}{%
\subsection{5.3 Physical Damage and Operational Impact}\label{physical-damage-and-operational-impact-3}}
...
\hypertarget{root-cause-and-remediation-3}{%
\subsection{5.4 Root Cause and Remediation}\label{root-cause-and-remediation-3}}
...
\hypertarget{tore-supra-west-2017-runaway-electron-radiative-heating-and-superconducting-magnet-quench}{%
\section{Tore Supra / WEST (2017): Runaway Electron Radiative Heating and Superconducting Magnet Quench}\label{tore-supra-west-2017-runaway-electron-radiative-heating-and-superconducting-magnet-quench}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[End{-}of{-}Shot Plasma Disruption] {-}{-}\textgreater{} B[Unmitigated Runaway Electron Beam]}
\NormalTok{    B {-}{-}\textgreater{} C[Wall Impact \& High{-}Energy Bremsstrahlung Generation]}
\NormalTok{    C {-}{-}\textgreater{} D[Penetrating Radiative Flux Through Vacuum Vessel]}
\NormalTok{    D {-}{-}\textgreater{} E[Localized Volumetric Heating of TFC9 Winding]}
\NormalTok{    E {-}{-}\textgreater{} F[Winding Exceeds Minimum Quench Energy MQE]}
\NormalTok{    F {-}{-}\textgreater{} G[Superfluid Helium Bath 1.8 K Thermal Transition]}
\NormalTok{    G {-}{-}\textgreater{} H[QDS Triggered / 6 kg/s Supercritical Helium Venting]}
\end{Highlighting}
\end{Shaded}

\hypertarget{technical-and-design-baseline-4}{%
\subsection{6.1 Technical and Design Baseline}\label{technical-and-design-baseline-4}}
...
\hypertarget{chronology-of-the-incident-4}{%
\subsection{6.2 Chronology of the Incident}\label{chronology-of-the-incident-4}}
...
\hypertarget{physical-damage-and-operational-impact-4}{%
\subsection{6.3 Physical Damage and Operational Impact}\label{physical-damage-and-operational-impact-4}}
...
\hypertarget{root-cause-and-remediation-4}{%
\subsection{6.4 Root Cause and Remediation}\label{root-cause-and-remediation-4}}
...
\hypertarget{jt-60sa-2021-dielectric-breakdown-and-supercritical-helium-leakage}{%
\section{JT-60SA (2021): Dielectric Breakdown and Supercritical Helium Leakage}\label{jt-60sa-2021-dielectric-breakdown-and-supercritical-helium-leakage}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Superconducting Commissioning 5 kV Test] {-}{-}\textgreater{} B[Dielectric Breakdown at EF1 Terminal Joint]}
\NormalTok{    B {-}{-}\textgreater{} C[Electrical Arc Formation to Ground Support Bracket]}
\NormalTok{    C {-}{-}\textgreater{} D[1.4s Short{-}Circuit Loop / 60 kJ Energy Release]}
\NormalTok{    D {-}{-}\textgreater{} E[Localized Melting of Superconducting Joint Casing]}
\NormalTok{    E {-}{-}\textgreater{} F[Supercritical Helium Line Puncture \& Leak]}
\NormalTok{    F {-}{-}\textgreater{} G[Cryostat Vacuum Boundary Degradation]}
\NormalTok{    G {-}{-}\textgreater{} H[2.5{-}Year Remediation / Redesign of 100+ Insulating Joints]}
\end{Highlighting}
\end{Shaded}

\hypertarget{technical-and-design-baseline-5}{%
\subsection{7.1 Technical and Design Baseline}\label{technical-and-design-baseline-5}}
...
\hypertarget{chronology-of-the-incident-5}{%
\subsection{7.2 Chronology of the Incident}\label{chronology-of-the-incident-5}}
...
\hypertarget{physical-damage-and-operational-impact-5}{%
\subsection{7.3 Physical Damage and Operational Impact}\label{physical-damage-and-operational-impact-5}}
...
\hypertarget{root-cause-and-remediation-5}{%
\subsection{7.4 Root Cause and Remediation}\label{root-cause-and-remediation-5}}
...
\hypertarget{comparative-analysis-of-excursion-parameters}{%
\section{Comparative Analysis of Excursion Parameters}\label{comparative-analysis-of-excursion-parameters}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0950}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1400}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.1150}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2850}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2850}}@{}}
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{1973} & \textbf{TFR} & Relativistic Runaway Electrons & \textasciitilde50 keV per particle & Localized vacuum-vessel bellows melt-through {[}2{]} & None (Disruption occurred before detection) \\
\textbf{1980} & \textbf{TFTR} & Kinetic Flywheel Instability & Multi-MJ (Mechanical) & Structural damage to generator housing {[}4{]} & Dynamic balancing instrumentation upgraded {[}5{]} \\
\textbf{1990s} & \textbf{JET} & Electromagnetic \(J \times B\) Forces & \(>25.5\text{ MN}\) vertical load & Displacement of the \(2,600\text{-tonne}\) assembly {[}8{]} & Mechanical restraints and SPI/MGI installed {[}7, 8{]} \\
\textbf{2004} & \textbf{JT-60U} & Cyclic Mechanical Fatigue & \(2.65\text{ GJ}\) stored kinetic & Generator offline; TF field limited to \(<3\text{ T}\) {[}9{]} & Heating grid bypass implemented {[}10{]} \\
\textbf{2017} & \textbf{WEST} & Secondary Bremsstrahlung & Kilojoules (Volumetric) & Superfluid helium (\(1.8\text{ K}\)) coil quench {[}11{]} & QDS and FSD successfully discharged magnets {[}12{]} \\
\textbf{2021} & \textbf{JT-60SA} & Dielectric Insulation Failure & \textasciitilde60 kJ (Electrical) & Supercritical helium leak; cryostat vacuum loss {[}13{]} & Rupture discs and Global Paschen Tests {[}14, 15{]} \\
\end{longtable}
}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{discussion-and-engineering-synthesis}{%
\section{Discussion and Engineering Synthesis}\label{discussion-and-engineering-synthesis}}
...
\item
  \textbf{Electromagnetic and Mechanical Force Management:} Structural frame designs must account for large, transient asymmetric forces during vertical displacement events. Designing for gravity loads alone is insufficient; support structures must accommodate dynamic, multi-meganewton lateral and vertical loads to prevent structural displacement {[}8{]}.
\item
  \textbf{Disruption Mitigation and Runaway Electron Suppression:} Runaway electron beams present a severe threat to vacuum boundary and magnet system integrity {[}2, 11{]}. Active suppression methods, such as shattered pellet injection (SPI) or active magnetic perturbation coils, must be integrated to prevent relativistic electron beams from localized wall impacts and secondary Bremsstrahlung heating of superconducting windings.
\item
