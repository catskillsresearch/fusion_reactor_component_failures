...
\title{\textbf{Experimental Fusion Reactor "Fender Benders": A Historical Registry of Non-Thermonuclear Energetic Excursions}}
...
\centering
\begin{center}
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/tfr-runaway-electron.png}
\end{center}
...
\centering
\begin{center}
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/tftr-motor-generator.png}
\end{center}
...
\centering
\begin{center}
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/jet-reactor-bounce.png}
\end{center}
...
\centering
\begin{center}
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/jt60u-mg-rotor.png}
\end{center}
...
\centering
\begin{center}
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/tore-supra-quench.png}
\end{center}
...
\centering
\begin{center}
\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/jt60sa-hv-arc.png}
\end{center}
